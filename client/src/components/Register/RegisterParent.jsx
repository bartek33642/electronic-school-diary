  ...
  const handleRegister = () => {
    ...
    return (
      <div className="register-form">
        ...
        Uczeń:
      <select name="student-select" id="student-select" className="register-input" onChange={(e) => setSelectedStudent(e.target.value)} value={selectedStudent} disabled={!selectedSchool}>
