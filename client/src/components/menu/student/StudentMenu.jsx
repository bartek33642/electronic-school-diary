      ...
      <nav className="nav-menu">
        <ul className="menu-ul">
          ...
          <li className="menu-li">
            ...
            <Link to="/student-marks" className="LinkBtn">
              {" "}
          ...
          <li className="menu-li">
            ...
            <Link to="/student-timetable" className="LinkBtn">
              {" "}
          ...
          <li className="menu-li">
            ...
            <Link to="/student-topics" className="LinkBtn">
              {" "}
          ...
          <li className="menu-li">
            ...
            <Link to="/student-attendance" className="LinkBtn">
              {" "}
          ...
          <li className="menu-li">
            ...
            <Link to="/student-remarks" className="LinkBtn">
              {" "}
          ...
          <li className="menu-li">
            ...
            <Link to="/student-subjects" className="LinkBtn">
              {" "}
          ...
          <li className="menu-li">
            ...
            <Link to="/student-settings" className="LinkBtn">
