      ...
      <nav className="nav-menu">
        <ul className="menu-ul">
          ...
          <li className="menu-li">
            {" "}
            <FiUser className="Fi" />
            <Link to="/users-admin" className="LinkBtn">
              {" "}
          ...
          <li className="menu-li">
            {" "}
            <FiMap className="Fi" />
            <Link to="/schools" className="LinkBtn">
              {" "}
              <span className="nav-item">Szkoły</span>
            </Link>
          </li>
          <li className="menu-li">
            {" "}
            <FiGrid className="Fi" />
            <Link to="/admin-classes" className="LinkBtn">
              {" "}
          ...
          <li className="menu-li">
            ...
            <Link to="/admin-grades" className="LinkBtn">
              {" "}
          ...
          <li className="menu-li">
            ...
            <Link to="/admin-timetable" className="LinkBtn">
              {" "}
          ...
          <li className="menu-li">
            ...
            <Link to="/admin-topics" className="LinkBtn">
              {" "}
          ...
          <li className="menu-li">
            ...
            <Link to="/admin-attendance" className="LinkBtn">
              {" "}
          ...
          <li className="menu-li">
            ...
            <Link to="/admin-remarks" className="LinkBtn">
              {" "}
          ...
          <li className="menu-li">
            ...
            <Link to="/admin-subjects" className="LinkBtn">
              {" "}
          ...
          <li className="menu-li">
            {" "}
            <FiCheckSquare className="Fi" />
            <Link to="/admin-polls" className="LinkBtn">
              {" "}
              <span className="nav-item"> Ankiety</span>
            </Link>
          </li>
          <li className="menu-li">
            {" "}
            <FiSettings className="Fi" />{" "}
            <Link to="/admin-settings" className="LinkBtn">
