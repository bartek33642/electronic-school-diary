      ...
      <nav className="nav-menu">
        <ul className="menu-ul">
          ...
          <li className="menu-li">
            ...
            <Link to="/parent-grades" className="LinkBtn">
              {" "}
          ...
          <li className="menu-li">
            ...
            <Link to="/parent-timetable" className="LinkBtn">
              {" "}
          ...
          <li className="menu-li">
            ...
            <Link to="/parent-topics" className="LinkBtn">
              {" "}
          ...
          <li className="menu-li">
            ...
            <Link to="/parent-attendance" className="LinkBtn">
              {" "}
          ...
          <li className="menu-li">
            ...
            <Link to="/parent-remarks" className="LinkBtn">
              {" "}
          ...
          <li className="menu-li">
            ...
            <Link to="/parent-subjects" className="LinkBtn">
              {" "}
          ...
          <li className="menu-li">
            ...
            <Link to="/parent-settings" className="LinkBtn">
