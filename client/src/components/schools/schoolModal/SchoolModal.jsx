      ...
      >
        <Box sx={{ ...style }} className="modal-content">
          ...
          <div className="box-modal">
            <div className="modal-text-titles">Nazwa szkoły:</div>
            ...
            <br />
            <div className="modal-text-titles">Miejscowość:</div>
            <div className="modal-text-inputs">
              <input
                type="text"
                name="miejscowosc"
            ...
            <br />
            <div className="modal-text-titles">Ulica:</div>
            <div className="modal-text-inputs">
              <input
                type="text"
                name="ulica"
            ...
            <br />
            <div className="modal-text-titles">Nr budynku:</div>
            <div className="modal-text-inputs">
              <input
                type="text"
                name="nr_budynku"
                id=""
                className="school-modal-input"
                value={newSchoolData.building_number}
                onChange={(e) =>
                  setNewSchoolData({
                    ...newSchoolData,
            ...
            <br />
            <div className="modal-text-titles">Numer lokalu:</div>
            <div className="modal-text-inputs">
              <input
                type="text"
                name="nr_lokalu"
                id=""
                className="school-modal-input"
                value={newSchoolData.apartment_number}
                onChange={(e) =>
                  setNewSchoolData({
                    ...newSchoolData,
            ...
            <br />
            <div className="modal-text-titles">Kod pocztowy: </div>
            <div className="modal-text-inputs">
              <input
                type="text"
                name="kod_pocztowy"
            ...
            <input
              type="submit"
              value="Zapisz"
              className="school-modal-button-save"
