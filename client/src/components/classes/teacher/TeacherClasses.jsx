                  ...
                  if (userData.length > 0) {
                    ...
                    console.log("classesTeacher: ", classesTeacher);
                      ...
                      if (classesTeacherResult.ok) {
                        ...
                        const uniqueClassesTeacherIds = Array.from(new Set(classesTeacher.map(classes => classes.school_id)));
                        const uniqueClassTeacher = classesTeacher.filter(classes => uniqueClassesTeacherIds.includes(classes.school_id));
                        setClasses(uniqueClassTeacher);
                      
                      } else {
                        setError("Błąd pobierania danych z danymi klas - dla roli nauczyciela.");
                      }
