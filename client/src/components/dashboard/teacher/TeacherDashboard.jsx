      ...
      <div className="dashboard">
        ...
        <div className="dasboard-content">
          ...
          <div className="users-button-components">
            <Link to="/teacher-marks" className="admin-button-content">
            ...
            <Link to="/teacher-topics" className="admin-button-content">
              <div className="admin-content-buttons">
                <div className="admin-button-first">
                  <div className="admin-button-first-left">
            ...
            <Link to="/teacher-settings" className="admin-button-content">
              <div className="admin-content-buttons">
                <div className="admin-button-first">
                  <div className="admin-button-first-left">
